...
export class WalkRightState implements IState {
    ...
    nextFrame(): FrameResult {
        ...
        // Use containerWidth from pet instead of window.innerWidth
        const maxRight = this.pet.containerWidth - this.pet.width;
...
export class ChaseState implements IState {
    ...
    nextFrame(): FrameResult {
        ...
        if (
            ...
            // hide ball
            this.canvas.addClass('pet-ball-hidden');
...
// Backward compatibility: Legacy PetState enum for migration
